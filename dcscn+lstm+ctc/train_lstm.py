...
#num_classes = 96
num_classes = 5689
fc_hidden_neuron = 1024

#loading data 
image_path = '/home/melt61/PictureGenerator/GenImage11'
label_path = '/home/melt61/PictureGenerator/GenLabel11/labels.txt'
...
with graph_1.as_default():
    ...
    #                    shape = [hidden_neuron*2, fc_hidden_neuron],
    #                    dtype = tf.float32,
    ...
    #loss = warpctc_tensorflow.ctc(activations=logits, flat_labels=flatten_labels, label_lengths=label_len, input_lengths=seq_len, blank_label=5688)
    ...
    #ctc decoder
    decoded, log_prob = tf.nn.ctc_beam_search_decoder(logits, seq_len, merge_repeated = False, beam_width = 1)
...
with tf.device('/cpu:0'):
    ...
    with tf.Session(config = config,graph=graph_1) as sess:
        ...
        summary_writer = tf.summary.FileWriter('./logs/chi_5-10_2', sess.graph)
        ...
        for cur_epoch in range(num_epochs):
            ...
            for cur_batch in range(num_batches_per_epoch):
                ...
                batch_inputs, batch_seq_len, batch_labels, batch_label_len, batch_flatten_labels,_,_,_ = \
...
#options=run_options, run_metadata=run_metadata)
                ...
                if (cur_batch + 1) % 50 == 0:
               	    print('batch', cur_batch, ': time', time.time() - batch_time,'      batch_cost: ',batch_cost,'         batch_acc: ', train_acc)
                ...
                if step % validation_steps == 0:
                    saver.save(sess, "./model/model_08/model_08.ckpt")
                    acc_batch_total = 0
                    ler = 0
                    lr = 0
                    for j in range(num_batches_per_epoch_val):
                        ...
                        val_inputs, val_seq_len, val_labels, val_label_len, val_flatten_labels,_,_,_ = \
